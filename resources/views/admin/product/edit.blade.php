                ...
                <fieldset class="row mb-3">
                    ...
                    <div class="col-sm-10 d-flex">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="active" id="no_active" value="0" {{ $product->active == 0 ? ' checked="" ' : '' }}>
                            <label class="form-check-label" for="no_active">Không</label>
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="card-footer"> <button type="submit" class="btn btn-primary">Cập Nhập Sản Phẩm</button> </div>
            @csrf
        </form>
    </div>
@endsection
